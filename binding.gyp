{
  "targets": [
    {
      "target_name": "win32",
      "sources": ["src/win32.cc", "src/surface.cc", "src/text.cc", "src/desktop.cc", "src/bezels.cc", "src/gl.cc", "src/shell.cc", "src/glcontext.cc", "src/dnd.cc", "src/ime.cc", "src/uia.cc", "src/pane.cc",
        "src/frameclock.cc", "src/layer.cc"],
